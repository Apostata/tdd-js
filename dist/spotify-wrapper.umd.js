...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/umd.js");
/******/ })
/************************************************************************/
/******/ ({
...
/*!***********************!*\
  !*** ./src/config.js ***!
  \***********************/
/*! exports provided: API_URL, ACCESS_TOKEN, HEADERS */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const ACCESS_TOKEN = 'BQASU3sloEq-VywNVjx1fBjTBYywMMYYdbWcpbF6SozE7gQQQMbnz-ajmwna360xndUmoXBBWZhsrYF-lYa6UuK1AC4H8QYAkteCz0JG1gPxwdrG-zQqkf4kNU6rUQNmbAvREjHpHDgNE8zQCV8';
const HEADERS = {
...
class SpotifyWrapper {
  constructor(props) {
    this.apiURL = props.apiURL || _config__WEBPACK_IMPORTED_MODULE_2__["API_URL"];
    this.token = props.token;
    this.album = _album__WEBPACK_IMPORTED_MODULE_0__["default"].call(this);
    this.search = _search__WEBPACK_IMPORTED_MODULE_1__["default"].call(this);
  }
...
function searcher(type, query) {
  return this.request(`${this.apiURL}/search?query=${query}&type=${type}`);
}
...
module.exports = __webpack_require__(/*! ./index */ "./src/index.js").default;
